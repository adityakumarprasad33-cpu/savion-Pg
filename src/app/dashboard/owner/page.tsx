...
export default function OwnerDashboard() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-[#030712] selection:bg-primary/10 selection:text-primary relative overflow-x-hidden">
      ...
      <header className="bg-white/70 dark:bg-[#030712]/70 backdrop-blur-3xl border-b border-slate-200/50 dark:border-white/5 sticky top-0 z-50 py-3 px-6 md:px-8">
      ...
      <main className="flex-1 p-5 md:p-8 max-w-7xl mx-auto w-full relative z-10">
        ...
        <motion.div variants={itemVariants} className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          <div>
            <div className="flex items-center gap-1.5 text-primary mb-0.5">
              ...
              <span className="text-[8px] font-bold uppercase tracking-[0.2em]">Dashboard Terminal</span>
            </div>
          ...
          <Link href="/dashboard/owner/add-pg">
            <Button className="h-10 px-5 bg-slate-900 dark:bg-primary hover:bg-black dark:hover:bg-primary/90 text-white font-bold rounded-xl shadow-lg dark:shadow-[0_8px_30px_rgb(79,70,229,0.2)] transition-all active:scale-95 gap-2 text-xs">
        ...
        <motion.div variants={containerVariants} className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {[
            ...
            <motion.div 
              ...
              key={stat.label} 
              className="bg-white/40 dark:bg-[#0a0a0f]/40 backdrop-blur-3xl p-5 rounded-[2rem] border border-white/60 dark:border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.1)] hover:shadow-[0_8px_40px_rgb(79,70,229,0.1)] transition-all group relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-24 h-24 bg-primary/10 rounded-full blur-xl transition-transform group-hover:scale-150 duration-1000" />
              <div className="relative z-10 flex justify-between items-start mb-3">
                <div className={`w-9 h-9 ${stat.bg} rounded-xl flex items-center justify-center`}>
                  <stat.icon className={`w-4.5 h-4.5 ${stat.color}`} />
                </div>
                <div className="h-1 w-6 bg-slate-200/50 dark:bg-zinc-800/50 rounded-full overflow-hidden">
                   <div className={`h-full w-2/3 ${stat.color.replace('text-', 'bg-')} animate-shimmer-bg`} />
                </div>
              </div>
              <p className="relative z-10 text-[9px] font-bold uppercase tracking-[0.15em] text-slate-500 dark:text-slate-400 mb-0.5">{stat.label}</p>
              <h3 className="relative z-10 text-2xl font-black text-slate-900 dark:text-slate-100 tracking-tight">{stat.value}</h3>
            </motion.div>
          ))}
        </motion.div>
        ...
        <motion.div variants={containerVariants} className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6">
          ...
          <motion.div variants={itemVariants} className="lg:col-span-8">
            <div className="bg-white/40 dark:bg-[#0a0a0f]/40 backdrop-blur-3xl p-6 md:p-8 rounded-[2.5rem] border border-white/60 dark:border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.1)] relative overflow-hidden h-full min-h-[300px]">
          ...
          <motion.div variants={itemVariants} className="lg:col-span-4">
            <div className="bg-white/40 dark:bg-[#0a0a0f]/40 backdrop-blur-3xl p-6 rounded-[2.5rem] border border-white/60 dark:border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.1)] h-full flex flex-col relative overflow-hidden">
              <div className="flex justify-between items-center mb-6 relative z-10">
                <h3 className="font-bold text-xl text-slate-900 dark:text-slate-100 tracking-tight flex items-center gap-2">
                ...
                {pgs.map((pg, i) => {
                  return (
                    <motion.div 
                      ...
                      className="group bg-white/40 dark:bg-[#0a0a0f]/40 backdrop-blur-3xl rounded-[2rem] border border-white/60 dark:border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.1)] hover:shadow-[0_8px_40px_rgb(79,70,229,0.1)] transition-all duration-300 overflow-hidden flex flex-col cursor-pointer"
                    >
