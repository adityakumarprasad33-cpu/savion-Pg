...
export default function TenantDashboard() {
  ...
  const payForBooking = async (booking: Booking) => {
    ...
    if (tenantProfile.role !== "tenant" && tenantProfile.role !== "student") {
      alert("Only tenants can make rent payments.");
      return;
    }
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-[#030712] selection:bg-primary/10 selection:text-primary relative overflow-x-hidden">
      ...
      <header className="sticky top-0 z-50 py-5 px-6 md:px-12 bg-white/70 dark:bg-[#030712]/70 backdrop-blur-3xl border-b border-slate-200/50 dark:border-white/5 transition-all">
      ...
      <div className="bg-transparent pt-6 pb-2 relative z-10">
        <div className="container max-w-7xl mx-auto px-6 flex justify-start">
          <div className="flex gap-2 p-1.5 bg-white/40 dark:bg-white/5 backdrop-blur-3xl border border-white/60 dark:border-white/10 rounded-[1.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
            {([
              ...
              <button
                ...
                className={`flex items-center gap-2 px-6 py-2.5 rounded-2xl text-[11px] font-bold transition-all uppercase tracking-[0.15em] duration-300
                  ${activeTab === tab.key
                    ? "bg-white dark:bg-white/10 text-slate-900 dark:text-white shadow-lg scale-100 border border-white/50 dark:border-white/5"
                    : "text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-white hover:bg-white/50 dark:hover:bg-white/5 scale-95 border border-transparent"}`}
              >
        ...
        {activeTab === "home" && (
          ...
          >
            <motion.div variants={itemVariants} className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 relative z-10">
              <div>
                <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-100 tracking-tight">Welcome, {tenantProfile?.name?.split(" ")[0] || "Resident"}!</h2>
                <p className="text-slate-500 dark:text-slate-400 font-medium mt-1">Here&apos;s everything about your stay.</p>
              </div>
              <Link href="/search">
            ...
            {/* Premium Info Grid */}
            <motion.div variants={containerVariants} className="grid grid-cols-1 lg:grid-cols-3 gap-6 relative z-10">
              <motion.div variants={itemVariants} className="lg:col-span-1 bg-white/40 dark:bg-[#0a0a0f]/40 backdrop-blur-3xl p-10 rounded-[3rem] border border-white/60 dark:border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.1)] hover:shadow-[0_8px_40px_rgb(79,70,229,0.1)] hover:bg-white/60 dark:hover:bg-[#0a0a0f]/60 transition-all duration-500 relative overflow-hidden group">
                <div className="absolute top-0 right-0 w-40 h-40 bg-primary/10 rounded-full -mr-20 -mt-20 blur-xl transition-transform group-hover:scale-150 duration-1000" />
              ...
              <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
                 {/* Contract Card */}
                 <motion.div variants={itemVariants} className="bg-white/40 dark:bg-[#0a0a0f]/40 backdrop-blur-3xl p-8 rounded-[2.5rem] border border-white/60 dark:border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.1)] hover:shadow-[0_8px_40px_rgb(79,70,229,0.1)] hover:bg-white/60 dark:hover:bg-[#0a0a0f]/60 transition-all group relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-indigo-500/10 rounded-full blur-2xl transition-transform group-hover:scale-150 duration-1000" />
                 ...
                 {/* KYC Card */}
                 <motion.div variants={itemVariants} className="bg-white/40 dark:bg-[#0a0a0f]/40 backdrop-blur-3xl p-8 rounded-[2.5rem] border border-white/60 dark:border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.1)] hover:shadow-[0_8px_40px_rgb(79,70,229,0.1)] hover:bg-white/60 dark:hover:bg-[#0a0a0f]/60 transition-all group relative overflow-hidden">
                    <div className="absolute bottom-0 right-0 w-40 h-40 bg-emerald-500/10 rounded-full blur-2xl transition-transform group-hover:scale-150 duration-1000" />
                    <div className="relative z-10 flex items-center gap-4 mb-8">
             ...
             {/* My Bookings History */}
            <motion.div variants={itemVariants} className="space-y-6 relative z-10 mt-8">
